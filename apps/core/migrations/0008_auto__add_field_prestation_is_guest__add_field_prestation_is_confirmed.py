...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Prestation.is_guest'
        db.add_column(u'core_prestation', 'is_guest',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Prestation.is_confirmed'
        db.add_column(u'core_prestation', 'is_confirmed',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Prestation.is_guest'
        db.delete_column(u'core_prestation', 'is_guest')

        # Deleting field 'Prestation.is_confirmed'
        db.delete_column(u'core_prestation', 'is_confirmed')
