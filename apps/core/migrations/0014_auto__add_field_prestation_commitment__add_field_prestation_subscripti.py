...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'core_prestation', 'subscription',
                      self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2016, 1, 14, 0, 0), blank=True),
                      keep_default=False)
    ...
    models = {
        u'core.prestation': {
            ...
            'subscription': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2016, 1, 14, 0, 0)', 'blank': 'True'})
        },
        u'core.quotation': {
