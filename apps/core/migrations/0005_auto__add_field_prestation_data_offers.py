...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Prestation.data_offers'
        db.add_column(u'core_prestation', 'data_offers',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=30, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Prestation.data_offers'
        db.delete_column(u'core_prestation', 'data_offers')
